...
type config struct {
	...
	InitialBackoff    Duration           `json:"initial-backoff" toml:"initial-backoff" yaml:"initial-backoff"`
	MaxBackoff        Duration           `json:"max-backoff" toml:"max-backoff" yaml:"max-backoff"`
	BackoffMultiplier uint               `json:"backoff-multiplier" toml:"backoff-multiplier" yaml:"backoff-multiplier"`
	MaxAttempts       uint               `json:"max-attempts" toml:"max-attempts" yaml:"max-attempts"`
}
